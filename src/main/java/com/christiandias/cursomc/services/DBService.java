...
import com.christiandias.cursomc.domain.ItemPedido;
import com.christiandias.cursomc.domain.Pagamento;
import com.christiandias.cursomc.domain.PagamentoComBoleto;
import com.christiandias.cursomc.domain.PagamentoComCartao;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Christian", "christianltdias@gmail.com", "14359002785",TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("25231655","998606442"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null,"Rua Flores","300","Apt 203","Jardim","38220834",cli1, c1);
		Endereco e2 = new Endereco(null,"Avenida Matos","105","Sala 800","Centro","38777012",cli1, c2);
		
		Endereco e3 = new Endereco(null,"Rua Flores","53",null,"Tuna","28021330",cli2, c2);
		
		cli1.getEnderecos().addAll(Arrays.asList(e1,e2));
		cli2.getEnderecos().addAll(Arrays.asList(e3));

		// Primeiro o cliente pois este é independente do endereço
